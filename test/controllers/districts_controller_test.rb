...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { eligible_voters: @district.eligible_voters, invalid_votes: @district.invalid_votes, name: @district.name, valid_votes: @district.valid_votes, vote_cards: @district.vote_cards }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { eligible_voters: @district.eligible_voters, invalid_votes: @district.invalid_votes, name: @district.name, valid_votes: @district.valid_votes, vote_cards: @district.vote_cards }
    assert_redirected_to district_path(assigns(:district))
  end
